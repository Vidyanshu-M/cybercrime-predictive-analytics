"""Phase 8F: XGBoost Validation Probability Threshold Analysis.

Evaluates trade-offs across classification thresholds (0.10 to 0.90)
using the trained XGBoost baseline on validation data.
...
def main():
    print("=" * 75)
    print("PHASE 8F: XGBOOST THRESHOLD ANALYSIS (VALIDATION SET)")
    print("=" * 75)
