...
public class CaseController {
    ...
    @Auditable(action = "UPLOAD_EVIDENCE", entityType = "EVIDENCE")
    @PreAuthorize("hasAnyRole('ADMIN', 'I4C_OFFICER', 'STATE_OFFICER', 'DISTRICT_OFFICER')")
    ...
    public ResponseEntity<CaseResponse> updateCaseStatus(
        ...
        String ipAddress = httpRequest.getRemoteAddr();
        CaseResponse response = caseService.updateCaseStatus(id, request.status(), currentUser, ipAddress);
